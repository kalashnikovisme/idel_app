...
namespace idel_app.DB
{
    class CommandTo1C
    {
        ...
        public static string RequestIdel = @"ТоварыНаСкладах.Номенклатура.Артикул,
	               	 ТоварыНаСкладах.Номенклатура.Комментарий,
	                 ТоварыНаСкладах.Номенклатура.ОсновнойПоставщик.Наименование
	               ИЗ
